...
class HealthNewsActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener{
   ...
   * */
    fun fetchJson(){
        ...
        val url = "https://newsapi.org/v2/top-headlines?country=gb&category=health&" +
