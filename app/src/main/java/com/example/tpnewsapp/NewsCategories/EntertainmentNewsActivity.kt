...
class EntertainmentNewsActivity : AppCompatActivity(),NavigationView.OnNavigationItemSelectedListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textView.text = "Entertainment News"
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.Health -> {
                ...
                val intent = Intent(this, HealthNewsActivity:: class.java)
                this.startActivity(intent)
            }
   ...
   * */
    fun fetchJson(){
        ...
        val url = "https://newsapi.org/v2/top-headlines?country=gb&category=entertainment&" +
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                runOnUiThread {
                    news_gridView.adapter =
                        MainAdapter(
                            this@EntertainmentNewsActivity,
                            articleFeed
                        )
                }
